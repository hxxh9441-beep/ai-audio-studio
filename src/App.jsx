...
import { Mic, Volume2, Home, ShieldCheck, Languages, Database, CloudCog, Loader2 } from 'lucide-react'
...
/**
 * التطبيق الرئيسي — Hero-to-Workspace Flow:
 * Hero بملء الشاشة ← عند الضغط على زر يتم التمرير الناعم لقسم العمل
 * مع Sticky Header يظهر للتبديل الفوري بين الخدمتين.
 */
export default function App() {
  ...
  // وضع التوليد المختار (auto | webgpu | wasm) — يُحفظ محلياً ويُطبَّق على المحركين
  ...
  return (
    <ToastProvider>
      ...
      >
        <div className="max-w-3xl mx-auto px-4 pt-3">
          <div className="glass rounded-2xl px-3 py-2 flex items-center justify-between gap-2 shadow-xl shadow-black/30">
            ...
            {/* تبديل اللغة — يدوي بين العربية والإنجليزية (الاكتشاف التلقائي عند أول زيارة) */}
      ...
      <main className="pt-[51px]">
        ...
        <TTSSection engineMode={engineMode} />
